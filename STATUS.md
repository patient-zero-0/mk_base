...
M2 数学分析  ░░░░░░░░░░░░░░░░░░░░  📋 规划完成（_meta/m2-plan.md）· 待启动 Batch 1
```
...
| M2 | 数学分析 Ch3–Ch5 | 第 6–9 周 | ≥ 80 条 stable，例题配套完成 | 📋 规划完成（`_meta/m2-plan.md`）· 12 个 batch 拆分就绪 |
...
*M2 启动：Batch 1（8 条 Ch3 微分基础）— 详见 `_meta/m2-plan.md`。*
