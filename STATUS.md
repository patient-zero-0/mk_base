...
M1 数学分析  ████████████████████  ✅ 严格 100% 达标（2026-05-04）
                                    47 条 / 40 目标 · Ch1 习题 5 / Ch2 习题 5
                                    剩余：review → stable 升级、依赖图首版
```
...
| M1 | 数学分析 Ch1–Ch2 | 第 3–5 周 | ≥ 40 条 stable，依赖图首版 | 🔄 数量严格达标 47/40，所有 PRD 项 100%，待 review→stable 升级 + 依赖图建立 |
...
| 悬空引用数 | 0（main 分支） | 0（全库 45 条目，2090 公式） |
| 条目状态分布 | review ≥ 80% 时启动 stable 评审 | review = 47 / draft = 5（review 占比 90%） |
