...
| M3 | 高等代数 Ch1–Ch5 | 第 10–16 周 | ≥ 120 条 stable | 🚧 规划完成（`_meta/m3-plan.md`：120 条 / 20 批），待启动 Batch 1 |
...
*下一步：M3 高等代数 Ch1–Ch5（≥ 120 条 stable）规划已完成（`_meta/m3-plan.md`：5 章 / 120 条 / 20 批），从 Ch1 Batch 1 起开发。*
