...
M1 数学分析  ████████████████████  ✅ 数量达标 40 / 40（2026-05-03 同日）
...
| M1 | 数学分析 Ch1–Ch2 | 第 3–5 周 | ≥ 40 条 stable，依赖图首版 | 🔄 数量达标 40/40，待 review→stable 升级 + 依赖图建立 |
...
| 条目状态分布 | review ≥ 80% 时启动 stable 评审 | review = 40 / draft = 5（review 占比 89%） |
